...
def main():
    ...
    parser.add_argument("--max-steps", type=int, default=None,
        help="Maximum training steps before exit (default: unlimited)")
    ...
    tfprocess.process(train_parser, test_parser, max_steps=args.max_steps)
...
class TestParse(unittest.TestCase):
    def test_datasrc(self):
        ...
        for x in range(num_chunks):
            filename = os.path.join(tempfile.gettempdir(), 'parse-unittest-chunk'+str(x)+'.gz')
